...
Step 4: You will be working with a number of quantitative variables in this dataset. Histograms are useful to understand the distribution of quantitative variables. Choose two continuous variables and create a code chunk that produces a histogram of each variable. 
